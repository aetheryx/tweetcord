async function inviteCommand (msg, args) {
  ...
  return {
    description: `Click [here](https://discordapp.com/oauth2/authorize?permissions=27712&scope=bot&client_id=${msg.author.id === this.config.ownerID ? IDArgument : this.bot.user.id}) to invite me to your server, ` +
